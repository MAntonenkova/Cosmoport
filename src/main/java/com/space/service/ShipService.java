...
public class ShipService {
    ...
    public List<Ship> getSortedShipsList(List<Ship> list,
        ...
        //по умолчанию 3 корабля на странице отображается
    ...
    // бизнес логика, подсчет рейтинга корабля
...
//		- год производства находится вне заданных пределов.;
        ...
        // инициализация параметров нового корабля
    ...
    public boolean updateShip(Ship ship, Ship jsonBody) {
        try { // проверка на то, что запрос пустой
            jsonBody.equals(new Ship());
            // если запрос пустой, то поля == null, поэтому выбросится исключение
